...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("c:/Users/Administrator/Desktop/scripts_loop.log"),  # Salva o log em um arquivo
...
scripts = [
    'python "c:/Users/Administrator/OneDrive - CARBON CARS/PowerBI/Scripts/carbon-bi/ph_paid_users_local.py"',
